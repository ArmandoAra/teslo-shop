...
-- AddForeignKey
ALTER TABLE "public"."OrderAddress" ADD CONSTRAINT "OrderAddress_countryId_fkey" FOREIGN KEY ("countryId") REFERENCES "public"."Countries"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
