        ...
        <div className="flex flex-col justify-center items-center p-4 mb-20">
            ...
            <div className="w-full flex flex-col md:grid md:grid-cols-[2fr_1fr] justify-center items-start gap-10">
                ...
                <div className="flex flex-col items-center mt-10 w-full">
                    ...
                    <Link href={"/cart"} className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                        Edit Cart
                    </Link>
                </div>
                ...
                <div className="flex flex-col items-center w-3/4 mx-auto md:mx-0 md:w-2/3 mt-10 gap-4">
                    ...
                    <div className="flex flex-col  items-center mt-4">
                        ...
                        <label htmlFor="terms" className="text-sm">I agree to the <a href="#" className="text-blue-500 underline">terms and conditions</a></label>
                        <p className="text-sm text-gray-500">By checking this box, you confirm that you have read and agree to the terms and conditions.</p>
                    </div>

                    <Link href="/orders/231" className="mt-4 px-4 py-2 bg-green-700 text-white rounded hover:bg-green-900">
                        Proceed to Buy
                    </Link>
                </div>
            </div >
